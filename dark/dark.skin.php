...
<script src="<?php echo $url_prefix; ?>skins/kiwitic/dark/Gadget-ReferenceTooltips-ko.js" charset='utf-8'></script>
</head>
    <header class="head-section">
      <div class="navbar navbar-default navbar-static-top container">
          <div class="navbar-header">
              ...
              <span class="icon-bar"></span></button> <a class="navbar-brand" href="<?php echo $this->data['nav_urls']['mainpage']['href']; ?>"><img src='/skins/kiwitic/dark/logo.png' width='200px'></a>
          </div>

...
$wgResourceModules['skins.acme'] = array(
	...
	'scripts' => array(
		$skinDir . '/js/affix.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/alert.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/button.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/carousel.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/collapse.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/dropdown.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/modal.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/popover.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/scrollspy.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/tab.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/tooltip.js'            => array( 'media' => 'all' ),
		$skinDir . '/js/transition.js'            => array( 'media' => 'all' ),
	),
	'dependencies' => array(
		'jquery',
		'jquery.mwExtension',

...
//		트위터 카드 시작
		...
		$out->addMeta('twitter:site', '@MirrorKiwi');
    ...
    <header class="head-section">
      <div class="navbar navbar-default navbar-static-top container">
          <div class="navbar-header">
              ...
              <span class="icon-bar"></span></button> <a class="navbar-brand" href="<?php echo $this->data['nav_urls']['mainpage']['href']; ?>"><img src='/skins/kiwitic/img/dark.mirror.png' width='200px'></a>
          </div>
...
<span style="display:none">Random</span></a><a class="scroll-button" href="<?php echo $url_prefix.'index.php?title='.$_URITITLE.'&oldid='.$revid.'&action=edit'; ?>"><i class="fa fa-pencil" aria-hidden="true"></i>
    ...
    <footer class="footer-small" id="footer">
        <div class="container">
            <div class="row">
                  <div class="copyright">
                    <p>내용은 별도로 명시하지 않을 경우 <a style='color:#AA7949;' href="https://creativecommons.org/licenses/by-sa/4.0/deed.ko">Attribution-ShareAlike 4.0 International(CC BY-SA 4.0)</a>에 따라 사용할 수 있습니다.<br>문의메일 : <a style='color:#AA7949;' href="mailto:mirror@kiwki.us">mirror@kiwki.us</a><br>이곳은 미러입니다. 수정을 원하시면 <a style='color:#AA7949;' href="https://kiwki.us">위키</a>로 가주세요.<br><br><br></p>
					...
					<a href="//secure.comodo.com/ttb_searcher/trustlogo?v_querytype=W&v_shortname=CL1&v_search=https://mirror.kiwki.us/&x=6&y=5"><img class="pull-right" src="//mirror.kiwki.us/comodo_secure_seal.png"></a>
                  </div>
            </div>
        </div>
    </footer>
